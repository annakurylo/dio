...
let series = ref([{
  name: 'Річна іонізація',
  data: [2000, 2100, 2200, 2200, 2300, 2200]
}])
...
const handleSelectionChange = () => {
  const randomData = generateRandomData(6, 1400, 2600)
      ...
      <v-card-title>
        <div class="d-flex align-end">
          <span class="text mb-1 w-25">
            Статистика іонізації у {{selectedRoom}}
          </span>
          <v-spacer />
          <VSelect
