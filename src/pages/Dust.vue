...
import Range from '@/views/dashboard/RangeD.vue'
import Statistics from '@/views/dashboard/StatysticsD.vue'
import Notifications from '@/views/dashboard/Notifications.vue'
import ChartT from '@/views/dashboard/ChartD.vue'
import HumidityToday from '@/views/dashboard/DustTodayy.vue'
  ...
  <VRow>
    ...
    >
      <AverageValueInTheHome
        v-bind="{averageValue: 10, indicator: 'Пил', measurement: 'µg/m³'}"/>
    </VCol>
