...
import Range from '@/views/dashboard/RangeW.vue'
import Statistics from '@/views/dashboard/StatysticsW.vue'
import Notifications from '@/views/dashboard/Notifications.vue'
import ChartW from '@/views/dashboard/ChartW.vue'
import HumidityToday from '@/views/dashboard/WaterToday.vue'
...
<template>
  <VRow>
    ...
    <VCol
      ...
      md="8"
    >
      <AverageValueInTheHome
        v-bind="{averageValue: 7, indicator: 'Якість води', measurement: 'pH'}"/>
    </VCol>
    ...
    >
      <VRow>
        ...
        >
          <CardValueNowRoom
            v-bind="{
              title: `Вітальня (з цієї кімнати немає доступу до води)`,
              image: living_room,
              value: null,
              type: 'water',
              measure: ''
    ...
    >
      <VRow>
        ...
        >
          <CardValueNowRoom
            v-bind="{
              title: 'Спальня (з цієї кімнати немає доступу до води)',
              image: bedroom,
              value: null,
              type: 'water',
              measure: ''
